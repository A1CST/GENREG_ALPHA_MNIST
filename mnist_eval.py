# ================================================================
# GENREG MNIST Evaluation Script
# ================================================================
# Evaluates a trained MNIST genome on the official 10K test set.
#
# Usage:
...
# EVALUATION
# ================================================================
def evaluate_genome(controller, test_dataset):
    """
    ...
    for idx, (image, label) in enumerate(test_dataset):
        ...
        # Get prediction
        digit_probs = controller.forward_visual(obs)
...
# INFERENCE BENCHMARK
# ================================================================
def run_inference_benchmark(controller, test_dataset, iterations=1000):
    """
...
def main():
    ...
    # Run evaluation
    results = evaluate_genome(controller, test_dataset)

    # Print results
    print_results(results, genome_info)

    # Run inference benchmark
    benchmark_results = run_inference_benchmark(controller, test_dataset)
