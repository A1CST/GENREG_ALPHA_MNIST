# ================================================================
# GENREG Alphabet Inference Tool
# ================================================================
# Standalone script to test a trained alphabet model.
#
# Features:
...
def load_genome(genome_info):
    ...
    expected_input = cfg.ALPHABET_FIELD_WIDTH * cfg.ALPHABET_FIELD_HEIGHT
...
class LetterRenderer:
    ...
    def __init__(self):
        self.width = cfg.ALPHABET_FIELD_WIDTH
        self.height = cfg.ALPHABET_FIELD_HEIGHT
        self.surface = pygame.Surface((self.width, self.height))
        self.font = pygame.font.Font(None, cfg.ALPHABET_FONT_SIZE)
...
class AlphabetInferenceUI:
    ...
    def test_letter(self, letter):
        ...
        char = self.controller.generate_char(obs)
    ...
    def run_5cycle_test(self):
        ...
        for cycle_num in range(1, 6):
            ...
            for letter in shuffled:
                # Test the letter
                obs = self.renderer.render(letter)
                predicted = self.controller.generate_char(obs).upper()
...
def main():
    ...
    # Run UI
    ui = AlphabetInferenceUI(controller)
    ui.run()
